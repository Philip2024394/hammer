...
export function XratedSocialShareStrip({
  ...
  const btnClass =
    "inline-flex h-11 items-center gap-2 rounded-lg border border-brand-line bg-black/40 px-3 text-xs font-semibold text-brand-text transition hover:border-brand-accent hover:text-brand-accent active:scale-95";
