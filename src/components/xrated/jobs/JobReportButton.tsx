      ...
      <div className="rounded-2xl border border-brand-line bg-brand-surface p-4">
        ...
        <div className="mt-3 flex flex-col gap-2 sm:flex-row">
          ...
          <select
            ...
            className="h-11 flex-1 rounded-lg border border-brand-line bg-black/40 px-3 text-xs text-brand-text focus:border-[#F97316] focus:outline-none"
          >
            {REASONS.map((r) => (
          ...
          <button
            ...
            onClick={submit}
            disabled={status === "submitting"}
            className="inline-flex h-11 items-center justify-center rounded-lg border border-brand-line bg-black/40 px-4 text-xs font-semibold text-brand-text transition hover:border-[#F97316] hover:text-[#F97316] disabled:opacity-60"
          >
