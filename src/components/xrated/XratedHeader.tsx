...
// Logo on the left, "List your trade" CTA pinned right (always visible —
// mobile shows the short form, sm+ shows the full label). Search lives BELOW
// the header on the landing page (see SearchHero) so the input can be much
...
export function XratedHeader() {
  return (
    <header className="sticky top-0 z-30 bg-black/95 backdrop-blur">
      <div className="mx-auto flex h-[68px] max-w-6xl items-center justify-between gap-3 px-4 sm:h-[72px] sm:gap-4">
        <a
          href="/trade-off"
