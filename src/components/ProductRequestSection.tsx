      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-6">
        <div className="flex flex-col justify-between rounded-2xl border border-brand-line bg-brand-surface p-4 sm:p-6">
          <div>
            ...
            <p className="mt-2 text-[11px] leading-relaxed text-brand-muted sm:mt-3 sm:text-sm">
          ...
          <div className="mt-4 flex flex-col gap-2">
            <button
              ...
              className="grid h-11 grid-cols-[1fr_auto] items-center gap-2 rounded-md bg-brand-accent px-3 text-[11px] font-bold uppercase tracking-wider text-black hover:opacity-90 sm:h-12 sm:text-xs"
            >
              <span>Discuss your project</span>
              <span aria-hidden="true">→</span>
            </button>
            <p className="text-[10px] text-brand-muted sm:text-[11px]">We reply within 24 hours.</p>
          </div>
        </div>

        <div className="aspect-[4/3] overflow-hidden rounded-2xl border border-brand-line bg-black">
          <img
            src="https://ik.imagekit.io/pinky/Untitledsdfsdfsdssddds.png"
